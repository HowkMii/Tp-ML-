...
data = data.drop(["TransactionId", "BatchId" ,"SubscriptionId" ,"AccountId","CustomerId","ProductCategory","CurrencyCode","ProviderId","ProductId","ChannelId","CountryCode","TransactionStartTime"], axis = 1)
...
x_train , x_test , y_train , y_test = train_test_split(red_X,y , test_size = 0.3 , random_state = 0)
